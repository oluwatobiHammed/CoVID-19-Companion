...
//protocol BottomSheetCloseDelegate {
//    func bottomSheetWillClose(controller: BottomSheetViewController)
//    func bottomSheetDidClose(controller: BottomSheetViewController)
//}
